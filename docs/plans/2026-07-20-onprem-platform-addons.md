...
> ⚠️ **`JOURNEY.md`는 2026-08-15에 레포에서 삭제됐다(의도된 삭제).** 아래 본문이 7곳에서
> 그것을 참조하지만 **범위를 정의한 출처일 뿐 구속 조건이 아니다** — 무엇을 지을지는 이미
> 이 문서의 Phase/DoD가 담고 있고, 삭제로 바뀐 DoD는 없다. 참조는 **연혁으로 읽을 것.**
