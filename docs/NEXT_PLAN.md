...
최종 갱신: 2026-07-11 (Task 11 [auto] 완료)

> **열린 작업만.** 완료 이력은 `COMPLETED_SUMMARY.md` / `PROGRESS_LOG.md`를 참조한다. **≤120줄** 유지.

## Task 11: Dashboard live data pipeline + Auth

- [x] [auto] Executor에서 `platform-agent-activity` 테이블에 deployment/activity 기록 write path 구현
- [x] [auto] Auth.js Phase 1: GitHub OAuth + 세션 미들웨어 + 보호 라우트 적용
