...
## 현재 상태 (2026-08-15, gate 2027 — 로컬 macOS·py3.13 · ⚠️CI 일치는 1912까지)
...
- [x] ~~게이트 288초 중 200초가 한 파일~~ → **닫힘(08-15, D49)**. 느린 게 아니라 **테스트마다
  Gemini를 과금 호출**하고 있었다(D45 위반). egress 차단 → **288s→39s**, 깨진 테스트 0건.
