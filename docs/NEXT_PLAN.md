...
## 현재 상태 (2026-08-15, gate 2021 — 로컬 macOS·py3.13 · ⚠️CI 일치는 1912까지)
...
- [ ] **게이트 288초 중 200초가 한 파일(08-15 실측)** — `test_gcp_day2_operations.py` **200.66s** vs
  형제 `test_azure_day2_operations.py` **0.43s**(같은 28건). **형제 중 하나만 느리다.** **미진단.**
