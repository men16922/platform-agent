...
## 2026-08-08 — Cosign은 게이트가 아니었다: 승인이 아니라 선행이 막고 있었다 (gate 1636→1640)
...
- Next: ④어드미션만 승인 사항이고, 그 전에 **CI를 만들 것인가**와 **키 custody**가 붙는다 —
  **키리스는 키를 없애서 custody를 푼다**는 점에서 사실 한 결정이다. Phase 4/5는 그대로.
