...
Usage:
    python -m src.agents.ai.orchestrator --service orders-api --version v1.4.2 --env staging --provider local
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--provider", default="local", help="Cloud provider (local/aws/gcp/azure)")
